...
namespace web_scraper.Lists.Categories.jobreg {

	public class JobregCategories {
		/*
		 *
		...
		public readonly Dictionary<string, string> BranchNames = new Dictionary<string, string>() {
		...
		public readonly Dictionary<string, List<string>> BranchLinkCategories = new Dictionary<string, List<string>>() {
		...
		public readonly Dictionary<string, string> Categories = new Dictionary<string, string>() {
